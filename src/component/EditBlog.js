...
function EditBlog() {
  ...
  let [oldImageUrl, setOldImageUrl] = useState('')
  ...
  const formik = useFormik({
    ...
    validationSchema:Yup.object({
      ...
      description:Yup.string().min(100, 'Min 100 Character Required').max(totalCount, 'Too Long').required('Required') 
    }),
    onSubmit:values=>{
